...
import com.example.jetpacklibrary.databinding.FragmentOneBinding
import com.example.jetpacklibrary.databinding.ItemRecyclerviewBinding
...
class MyDecoration(val context: Context): RecyclerView.ItemDecoration(){
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        //이미지를 출력할 위치 계산
        val left = with / 2 - drWidth?.div(2) as Int
