...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        val infulater = menuInflater
        infulater.inflate(R.menu.menu_main,menu)
        //MenuItem 객체를 얻고 그 안에 포함된 ActionView객체 획득
        val menuItem = menu?.findItem(R.id.menu_search)
        //검색과 관련된 기능을 구현하기 위해 SearchView객체를 얻음
        //SearchView를 등록한 MenuItem객체를 얻고 그 객체에 등록된 SearchView객체를 구현하면 됨
